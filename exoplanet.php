...
<html lang="en">
	...
	<body>
		...
		<div class = "searchExoplanet">
			<h5>Search for an exoplanet: </h5>
			<input id="searchExoplanetInput" type="text"><br><br>
			<button id="searchExoplanetButton">Search</button>
		</div>
		
		<div class = "consoleExoplanet">
			<h5>Open the console via the following instructions: <br><br>
			Right Click > Inspect > Console<br><br>
			Then hit "View Exoplanet Data on Console" to populate the console with asteroid data.<br><br>
			This will be in raw JSON format.</h5><br>
			
			<button id="consoleExoplanetButton">View Exoplanet Data on Console</button>
		</div>
		
		<div class = "displayExoplanet">
			<button id="displayExoplanetButton">Display Exoplanets</button>
		</div>
